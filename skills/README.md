...
| maintenance | task-board | Track tasks with lifecycle dates (started, ended, pushed) in shared/TASK-BOARD.md; render the client board at docs/board.html; reconcile pushed dates from git log |
