...
| Task board (source) | `shared/TASK-BOARD.md` | Per-task lifecycle: owner, status, started, ended, pushed |
| Task board (client view) | `docs/board.html` | Rendered kanban for Elvis, generated from TASK-BOARD.md |
